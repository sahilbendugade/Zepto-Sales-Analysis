...
📊 Zepto Sales Analysis – Data Analytics Project
📌 Overview

This project focuses on analyzing sales data from Zepto to uncover insights related to pricing, discounts, stock availability, and category-wise performance.
The analysis combines Python, SQL, and Power BI to demonstrate an end-to-end data analytics workflow—from raw data to an interactive business dashboard and final report.
...
This project demonstrates practical skills in data cleaning, analysis, SQL querying, dashboarding, and business reporting. It reflects a real-world analytics workflow and is suitable for Data Analyst / Business Analyst roles.
